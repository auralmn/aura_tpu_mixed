...
def stream_conversations(dataset_name: str,
    ...
    """
    Generic conversation streamer for HF datasets that provide messages/conversations
    or prompt/response pairs. Produces flattened plain text with role headers.
    """
    try:
